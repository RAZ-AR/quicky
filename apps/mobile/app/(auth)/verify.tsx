...
function makeStyles(C: AppColors, C_RADIUS = RADIUS) {
  return StyleSheet.create({
    ...
    logoText:   { fontSize: 30, fontWeight: '800', color: C.text, marginBottom: 28 },
    ...
    input:     { padding: 18, fontSize: 32, fontWeight: '700', color: C.text, letterSpacing: 10, position: 'relative' },

    btn:     { borderRadius: C_RADIUS.xl, overflow: 'hidden', paddingVertical: 16, alignItems: 'center', marginBottom: 8 },
    btnText: { fontSize: 16, fontWeight: '700', color: '#fff', position: 'relative' },

    backBtn:  { paddingVertical: 12, alignItems: 'center' },
    backText: { color: C.primaryLight, fontSize: 15 },
  });
}
