...
function makeStyles(C: AppColors, C_RADIUS = RADIUS) {
  return StyleSheet.create({
    ...
    title:    { fontSize: 28, fontWeight: '800', color: C.text, marginBottom: 8, textAlign: 'center' },
    subtitle: { fontSize: 16, color: C.textMuted, marginBottom: 28, textAlign: 'center' },

    starsRow:     { flexDirection: 'row', gap: 6, marginBottom: 12 },
    star:         { fontSize: 44, color: C.glass },
