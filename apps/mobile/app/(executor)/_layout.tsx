...
const EXECUTOR_TABS: TabConfig[] = [
  { name: 'index',   icon: 'G', ionIcon: 'flash-outline',  label: 'Главная' },
  { name: 'orders',  icon: 'Z', ionIcon: 'list-outline',   label: 'Задания' },
  { name: 'profile', icon: 'P', ionIcon: 'person-outline', label: 'Профиль' },
];
